...
with st.sidebar:
    ...
    use_mock = st.checkbox("Force Test Server Fallback", value=False, help="Connect to the local mock logs service running at http://localhost:8000/laravel.log")

# Fetch and cache log streams safely
raw_logs_content = ""
fetch_error = ""
